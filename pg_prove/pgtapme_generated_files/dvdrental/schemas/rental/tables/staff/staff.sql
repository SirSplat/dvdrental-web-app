BEGIN;
  ...
  SELECT columns_are('rental', 'staff', ARRAY['staff_id', 'first_name', 'last_name', 'address_id', 'email', 'store_id', 'active', 'username', 'password', 'last_update', 'picture', 'role_type']::TEXT[], 'Table rental.staff should have the correct columns.');
  ...
  SELECT col_isnt_pk('rental', 'staff', ARRAY['active', 'picture', 'first_name', 'email', 'password', 'username', 'last_update', 'role_type']::TEXT[], 'Table rental.staff should have the correct primary key columns.');
  ...
  SELECT col_isnt_fk('rental', 'staff', ARRAY['active', 'picture', 'staff_id', 'first_name', 'email', 'password', 'username', 'store_id', 'role_type']::TEXT[], 'Table rental.staff should have the correct foreign key columns.');
