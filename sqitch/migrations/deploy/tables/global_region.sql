-- Deploy dvdrental:tables/global_region to pg
-- requires: appschema
...
CREATE TABLE dsa.global_region (
    ...
    CONSTRAINT global_region_name_not_empty_chk CHECK ( BTRIM( region_name ) <> '' )
);
...
COMMENT ON CONSTRAINT global_region_name_not_empty_chk ON dsa.global_region IS 'Region name must not be empty.';
