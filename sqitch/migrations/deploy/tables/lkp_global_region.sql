...
CREATE TABLE dsa.lkp_global_region (
    ...
    CONSTRAINT lkp_global_region_code_length_chk CHECK ( LENGTH( region_code ) = 2 ),
    CONSTRAINT lkp_global_region_code_not_empty_chk CHECK ( BTRIM( region_code ) <> '' ),
...
COMMENT ON CONSTRAINT lkp_global_region_code_length_chk ON dsa.lkp_global_region IS 'Region code must be 2 characters long.';
COMMENT ON CONSTRAINT lkp_global_region_code_not_empty_chk ON dsa.lkp_global_region IS 'Region code must not be empty.';
